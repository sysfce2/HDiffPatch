...
extern "C" {
    ...
    Java_com_github_sisong_HPatch_patch(JNIEnv* jenv,jobject jobj,
                                        jstring oldFileName,jstring diffFileName,jstring outNewFileName,
                                        jlong cacheMemory,jint threadNum,jboolean isChecksumNewData){
        ...
        result=hpatchz(cOldFileName,cDiffFileName,cOutNewFileName,(int64_t)cacheMemory,(threadNum>1)?threadNum:1,isChecksumNewData);
    _clear:
